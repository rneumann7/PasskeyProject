...
func newEC2SigningKey() (*ec2SigningKey, []byte) {
	...
	return newEC2SigningKeyWithPrivateKey(privateKey, false), keyData
}

func importEC2SigningKey(keyData []byte, wrongAlg bool) *ec2SigningKey {
	...
	return newEC2SigningKeyWithPrivateKey(privateKey, wrongAlg)
}

func newEC2SigningKeyWithPrivateKey(privateKey *ecdsa.PrivateKey, wrongAlg bool) *ec2SigningKey {
	var usedAlg int64 = ec2SHA256Algo
	if wrongAlg {
		usedAlg = 0
	}
	info := ec2KeyInfo{
